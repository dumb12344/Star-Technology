...
Ponder.registry((event) => {
  event
    ...
    .scene(
      "classic_stargate",
      "Classic Stargate",
      global.ponderScenes["classic_stargate"]
    );
  ...
  event
    ...
    .scene(
      ...
      global.ponderScenes["multiblock_introduction"]
    )
    .scene(
      "multiblock_construction",
      "Multiblock Construction",
      global.ponderScenes["multiblock_construction"]
    )
    .scene(
      "multiblock_wallsharing",
      "Multiblock Wall Sharing",
      global.ponderScenes["multiblock_wallsharing"]
    );
});

GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('supreme_plasma_turbine', 'multiblock')
        ...
        .recipeModifiers([$StarTRecipeModifiers.BOOSTED_PLASMA_TURBINE, $StarTRecipeModifiers.LARGE_TURBINE])
        ...
        .pattern((definition) => FactoryBlockPattern.start()
            ...
            .where('X', Predicates.blocks('kubejs:enriched_naquadah_firebox_casing'))

...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('vibration_laser_engraver', 'multiblock')
        ...
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, $StarTRecipeModifiers.THROUGHPUT_BOOSTING, $StarTRecipeModifiers.BULK_PROCESSING, GTRecipeModifiers.OC_NON_PERFECT_SUBTICK, GTRecipeModifiers.BATCH_MODE])

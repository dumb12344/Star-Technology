ServerEvents.recipes(event => {
    ...
    HellForgeMat('borealic_steel', 20, ['gtceu:prismalium 288', 'gtceu:rose_gold 576', 'gtceu:aurourium 1152', 'gtceu:tritan_steel 288', 'gtceu:ancient_netherite 144', 'gtceu:borealic_concentrate 432'], 'argon', 'ascendant', 974, GTValues.VA[GTValues.UIV], 31.5)
    ...
    HellForgeMat('trikoductive_neutro_steel', 17, ['gtceu:isovol 864', 'gtceu:tritan_steel 720', 'gtceu:estalt 144', 'gtceu:ruthenium_trinium_americium_neutronate 432', 'gtceu:twinite 288'], 'helium', 'infernal', 981, GTValues.VA[GTValues.UIV], 35.1);
    ...
    HellForgeMat('hvga_steel', 16, ['gtceu:signalum 144', 'gtceu:hssg 432', 'gtceu:draco_abyssal 144', 'gtceu:hsla_steel 1152', 'gtceu:tritan_steel 432'], 'magmatic', 'abyssal', 1343, GTValues.VA[GTValues.UXV], 21.6);

ServerEvents.recipes(event => {
    ...
    special_ultimate_casing('draco_resilient_fusion_glass',['gtceu:fusion_glass', '12x kubejs:draconic_scale_cells', '1x gtceu:uhv_field_generator', '6x kubejs:borealic_neutron_reflector'], ['gtceu:poly_34_ethylenedioxythiophene_polystyrene_sulfate 1008', 'gtceu:dragon_breath 1250'], 'gtceu:fusion_glass');

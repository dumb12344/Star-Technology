...
ServerEvents.recipes(event => {
    ...
    UlvMachine('assembler',['gtceu:ulv_robot_arm','#gtceu:circuits/ulv','gtceu:ulv_robot_arm','gtceu:ulv_conveyor_module','gtceu:ulv_machine_hull','gtceu:ulv_conveyor_module','gtceu:red_alloy_single_cable','#gtceu:circuits/ulv','gtceu:red_alloy_single_cable']);
    UlvMachine('centrifuge',['#gtceu:circuits/ulv','gtceu:ulv_electric_motor','#gtceu:circuits/ulv','gtceu:red_alloy_single_cable','gtceu:ulv_machine_hull','gtceu:red_alloy_single_cable','#gtceu:circuits/ulv','gtceu:ulv_electric_motor','#gtceu:circuits/ulv']);
    UlvMachine('mixer',['#forge:glass','gtceu:cast_iron_rotor','#forge:glass','#forge:glass','gtceu:ulv_electric_motor','#forge:glass','#gtceu:circuits/ulv','gtceu:ulv_machine_hull','#gtceu:circuits/ulv']);
    UlvMachine('stirling_generator',['gtceu:tin_alloy_normal_fluid_pipe','#gtceu:circuits/ulv','gtceu:tin_alloy_normal_fluid_pipe','gtceu:cast_iron_rotor','gtceu:ulv_machine_hull','gtceu:cast_iron_rotor','gtceu:ulv_electric_motor','gtceu:red_alloy_single_cable','gtceu:ulv_electric_motor']);
    ...
    event.recipes.create.sequenced_assembly([
        Item.of(`gtceu:ulv_electric_motor`),
    ], motor, [
    ...
    event.recipes.create.sequenced_assembly([
        Item.of(`gtceu:ulv_conveyor_module`),
    ], conv, [
    ...
    event.recipes.create.sequenced_assembly([
        Item.of(`gtceu:ulv_electric_piston`),
    ], pist, [
    ...
    UlvComponent('conveyor_module',['1x gtceu:red_alloy_single_cable','2x gtceu:ulv_electric_motor'],'gtceu:rubber 864');
    UlvComponent('electric_piston',['2x gtceu:potin_rod','2x gtceu:red_alloy_single_cable','3x gtceu:potin_plate','1x gtceu:small_potin_gear','1x gtceu:ulv_electric_motor'],'');
    UlvComponent('robot_arm',['3x gtceu:red_alloy_single_cable','2x gtceu:potin_rod','2x gtceu:ulv_electric_motor','1x gtceu:ulv_electric_piston','1x #gtceu:circuits/ulv'],'');
    UlvComponent('electric_pump',['1x gtceu:red_alloy_single_cable','1x gtceu:tin_alloy_normal_fluid_pipe','1x gtceu:cast_iron_screw','1x gtceu:cast_iron_rotor','2x gtceu:rubber_ring','1x gtceu:ulv_electric_motor'],'');
    UlvComponent('emitter',['1x gtceu:ulv_electric_motor','4x gtceu:zinc_rod','2x gtceu:red_alloy_single_cable','2x #gtceu:circuits/ulv','1x minecraft:prismarine_crystals'],'');
